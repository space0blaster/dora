class E {
    ...
    static video(parent,className,id,src,ext) {
        let e=document.createElement('video');
        parent.appendChild(e);
        e.className=className;
        e.id=id;
        //e.innerHTML="<source src='"+src+"' type='video/"+ext+"'>";
    ...
    static audio(parent,className,id,src,ext) {
        ...
        s.type='audio/'+ext;
        e.appendChild(s);
        //e.innerHTML="<source src='"+src+"' type='audio/"+ext+"'>";
        return e;
    };
